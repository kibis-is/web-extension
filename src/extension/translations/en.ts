...
const translation: IResourceLanguage = {
  ...
  captions: {
    ...
    addPasskeyAccount:
      'A supported passkey can be used as an AVM account, this means you can sign transactions using an imported passkey.',
    addPasskeyAccountInfo: `The passkey contains the account's private key and it will not be passed to Kibisis.`,
    ...
    fetchingPasskeyDetails: 'Fetching Passkey details',
    ...
    importAccountViaPasskey: `Import an account using a Passkey.`,
    ...
    removeAccountWithPasskeyWarning:
      'To add this account you will need the passkey credential ID',
    removeAsset:
  ...
  headings: {
    ...
    importAccountViaPasskey: 'Using A Passkey',
    importAccountViaQRCode: 'Scan A QR Code',
    importAccountViaSeedPhrase: 'Using A Seed Phrase',
