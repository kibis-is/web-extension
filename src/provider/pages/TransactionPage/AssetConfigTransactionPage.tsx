...
// types
import type { IAssetConfigTransaction } from '@provider/types';
...
const AssetConfigTransactionPage: FC<IProps<IAssetConfigTransaction>> = ({ accounts, network, transaction }) => {
            ...
            {standardAsset?.url && (
              <PageItem fontSize="sm" label={t<string>('labels.url')}>
                <HStack spacing={0}>
                  ...
                  <OpenTabIconButton size="sm" tooltipLabel={t<string>('captions.openUrl')} url={standardAsset.url} />
                </HStack>
              </PageItem>
            )}
