...
// types
import type { IAssetDestroyTransaction } from '@provider/types';
...
const AssetDestroyTransactionPage: FC<IProps<IAssetDestroyTransaction>> = ({ accounts, network, transaction }) => {
