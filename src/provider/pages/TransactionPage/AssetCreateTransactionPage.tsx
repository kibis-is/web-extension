...
const AssetCreateTransactionPage: FC<IProps<IAssetCreateTransaction>> = ({ accounts, network, transaction }) => {
        ...
        {transaction.url && (
          <PageItem fontSize="sm" label={t<string>('labels.url')}>
            <HStack spacing={0}>
              ...
              <OpenTabIconButton size="sm" tooltipLabel={t<string>('captions.openUrl')} url={transaction.url} />
            </HStack>
          </PageItem>
        )}
