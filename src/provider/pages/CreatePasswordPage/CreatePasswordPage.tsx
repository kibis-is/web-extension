...
import { ADD_ACCOUNT_ROUTE } from '@provider/constants';

// features
import { setPassword } from '@provider/features/registration';
...
// types
import type { IAppThunkDispatch, IRegistrationRootState } from '@provider/types';
...
const CreatePasswordPage: FC = () => {
  ...
  return (
    <>
      {/*page title*/}
      <PageHeader colorMode={colorMode} title={t<string>('titles.page', { context: 'createPassword' })} />
