import { Avatar, Code, HStack, Icon, Spacer, Text, useDisclosure, VStack } from '@chakra-ui/react';
...
// features
import { removeAccountPasskeyByIDThunk } from '@provider/features/accounts';
...
// selectors
import { useSelectActiveAccount, useSelectSettingsColorMode } from '@provider/selectors';
  ...
  return (
    <>
      ...
      >
          ...
          <VStack spacing={0} w="full">
            ...
            <PageItem fontSize="xs" label={t<string>('labels.origin')}>
              <HStack spacing={1}>
                ...
                <OpenTabIconButton tooltipLabel={passkey.origin} url={passkey.origin} />
              </HStack>
            </PageItem>
            ...
            >
              <VStack spacing={0} w="full">
                ...
                {/*relaying party id*/}
                <PageItem fontSize="xs" label={t<string>('labels.relayingPartyID')}>
                  <HStack spacing={1}>
                    <Code borderRadius="md" color={defaultTextColor} fontSize="xs" wordBreak="break-word">
                      {passkey.rp.id}
                    </Code>
        ...
        {/*remove button*/}
        <HStack alignItems="center" justifyContent="center" spacing={DEFAULT_GAP / 3} mb={DEFAULT_GAP - 2} w="full">
          <Button
            colorMode={colorMode}
