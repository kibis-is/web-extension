...
const slice = createSlice({
  ...
  reducers: {
    initializeRemoveAssets: (state: Draft<IState>, action: PayloadAction<IInitializeRemoveAssetsPayload>) => {
...
export const { initializeRemoveAssets, reset, setAccountId, setConfirming, setSelectedAsset } = slice.actions;
