...
const slice = createSlice({
  extraReducers: (builder) => {
    ...
    builder.addCase(fetchFromStorageThunk.fulfilled, (state: IState, action: PayloadAction<ISettings>) => {
    ...
    builder.addCase(saveToStorageThunk.fulfilled, (state: IState, action: PayloadAction<ISettings>) => {
      state.saving = false;
