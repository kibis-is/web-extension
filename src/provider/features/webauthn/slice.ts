...
// thunks
import { sendWebAuthnAuthenticateResponseThunk, sendWebAuthnRegisterResponseThunk } from './thunks';
...
const slice = createSlice({
  extraReducers: (builder) => {
    ...
    builder.addCase(sendWebAuthnAuthenticateResponseThunk.fulfilled, (state) => {
      state.saving = false;
    });
