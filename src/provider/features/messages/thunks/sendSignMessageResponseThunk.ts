import { ARC0027MethodEnum, ISignMessageResult } from '@agoralabs-sh/avm-web-provider';
...
> = createAsyncThunk<
  ...
  IBaseAsyncThunkConfig<IBackgroundRootState | IMainRootState>
>(ThunkEnum.SendSignMessageResponse, async ({ error, event, signature, signer }, { getState }) => {
