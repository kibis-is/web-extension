...
// enums
import { ARC0072AssetsThunkEnum } from '@provider/enums';

// repositories
import ARC0072AssetRepository from '@provider/repositories/ARC0072AssetRepository';

// types
import type { IARC0072Asset, IBaseAsyncThunkConfig, IMainRootState } from '@provider/types';
import type { IUpdateARC0072AssetInformationPayload, IUpdateARC0072AssetInformationResult } from '../types';

// utils
import selectNodeIDByGenesisHashFromSettings from '@provider/utils/selectNodeIDByGenesisHashFromSettings';
import updateARC0072AssetInformationById from '@provider/utils/updateARC0072AssetInformationById';
...
> = createAsyncThunk<
  ...
  IBaseAsyncThunkConfig<IMainRootState>
>(ARC0072AssetsThunkEnum.UpdateARC0072AssetInformation, async ({ ids, network }, { getState }) => {
