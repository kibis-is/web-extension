...
// types
import type { IBaseAsyncThunkConfig, IMainRootState, INetworkWithTransactionParams } from '@provider/types';
...
> = createAsyncThunk<
  ...
  IBaseAsyncThunkConfig<IMainRootState>
>(ThunkEnum.RemoveCustomNodeThunk, async ({ genesisHash, id }, { getState }) => {
