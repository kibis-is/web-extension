...
// repositories
import CredentialLockService from '@provider/services/CredentialLockService';
...
> = createAsyncThunk<void, void, IBaseAsyncThunkConfig<IBackgroundRootState | IMainRootState>>(
  ThunkEnum.Disable,
  async (_, { getState }) => {
