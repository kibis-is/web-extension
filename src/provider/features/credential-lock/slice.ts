...
// thunks
import { deactivateThunk, disableThunk, enableThunk, fetchActiveThunk } from './thunks';
...
const slice = createSlice({
  extraReducers: (builder) => {
    ...
    /** fetch active **/
    builder.addCase(fetchActiveThunk.fulfilled, (state: IState, action: PayloadAction<boolean>) => {
