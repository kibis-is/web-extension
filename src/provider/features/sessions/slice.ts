...
// thunks
import { removeAllFromStorageThunk, fetchFromStorageThunk, removeByIdFromStorageThunk, saveToStorage } from './thunks';
...
const slice = createSlice({
  extraReducers: (builder) => {
    ...
    builder.addCase(removeByIdFromStorageThunk.fulfilled, (state: IState, action: PayloadAction<string>) => {
