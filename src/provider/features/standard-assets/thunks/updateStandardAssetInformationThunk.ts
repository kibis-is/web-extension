...
// types
import type { IBaseAsyncThunkConfig, IMainRootState, IStandardAsset } from '@provider/types';
import type { IUpdateStandardAssetInformationPayload, IUpdateStandardAssetInformationResult } from '../types';

// utils
import fetchVerifiedStandardAssetList from '@provider/utils/fetchVerifiedStandardAssetList';
import updateStandardAssetInformationById from '@provider/utils/updateStandardAssetInformationById';
...
> = createAsyncThunk<
  ...
  IBaseAsyncThunkConfig<IMainRootState>
>(StandardAssetsThunkEnum.UpdateStandardAssetInformation, async ({ ids, network }, { getState }) => {
