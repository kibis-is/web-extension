...
const slice = createSlice({
  ...
  reducers: {
    reset: (state: Draft<IState>) => {
      ...
      state.importAccountViaQRCodeModalOpen = initialState.importAccountViaQRCodeModalOpen;
      state.password = initialState.password;
      state.saving = initialState.saving;
    },
    setImportAccountViaQRCodeOpen: (state: Draft<IState>, action: PayloadAction<boolean>) => {
...
export const { reset, setImportAccountViaQRCodeOpen, setPassword } = slice.actions;
