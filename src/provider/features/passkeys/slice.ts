...
// thunks
import { fetchFromStorageThunk, removeFromStorageThunk, saveToStorageThunk } from './thunks';
...
const slice = createSlice({
  extraReducers: (builder) => {
    ...
    /** save to storage **/
    builder.addCase(saveToStorageThunk.fulfilled, (state: IState, action: PayloadAction<IPasskeyCredential>) => {
      state.passkey = action.payload;
      state.saving = false;
    });
