...
> = createAsyncThunk<string | null, TReKeyAccountThunkPayload, IBaseAsyncThunkConfig<IMainRootState>>(
  ThunkEnum.ReKeyAccount,
  async ({ authorizedAddress, network, reKeyAccount, ...encryptionOptions }, { getState, rejectWithValue }) => {
