...
// cryptography
import BaseSignKeyPair, { type IVerifyOptions } from '@provider/cryptography/BaseSignKeyPair';
...
export default class ES256KeyPair extends BaseSignKeyPair {
  ...
  public secretKey(): Uint8Array {
    const secretKey = new Uint8Array(this._privateKey.length + this._publicKey.length);
  ...
  public sign(bytes: Uint8Array): Uint8Array {
    return secp256r1.sign(bytes, this._privateKey, { prehash: true }).toCompactRawBytes();
  }
