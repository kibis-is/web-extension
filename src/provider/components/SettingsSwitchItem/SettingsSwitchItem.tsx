...
const SettingsSwitchItem: FC<IProps> = ({ checked, description, label, onChange }) => {
  ...
  return (
    ...
    >
      ...
      <Switch colorScheme={primaryColorScheme} isChecked={checked} onChange={onChange} size="lg" />
    </HStack>
  );
};
