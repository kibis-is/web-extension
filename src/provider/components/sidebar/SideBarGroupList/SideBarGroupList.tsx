...
// components
import SideBarGroupItem from '@provider/components/sidebar/SideBarGroupItem';
...
const SideBarGroupList: FC<IProps> = ({
  ...
  return (
    <DndContext sensors={sensors} collisionDetection={closestCenter} onDragEnd={handleOnGroupDragEnd}>
