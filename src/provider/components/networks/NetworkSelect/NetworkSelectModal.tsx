    ...
    if (networks.length <= 0) {
      return (
        <>
          ...
          {/*empty state*/}
          <EmptyState colorMode={colorMode} text={t<string>('headings.noNetworksFound')} />
    ...
    return networks.map((value, index) => {
      ...
      switch (value.type) {
        case NetworkTypeEnum.Beta:
          node = (
            <Tag borderRadius="full" colorScheme="blue" size="sm" variant="solid">
        ...
        case NetworkTypeEnum.Test:
          node = (
            <Tag borderRadius="full" colorScheme="yellow" size="sm" variant="solid">
        ...
        case NetworkTypeEnum.Stable:
          ...
          if (!containsOnlyStableNetworks(networks)) {
            node = (
              <Tag borderRadius="full" colorScheme="green" size="sm" variant="solid">
