...
const MoreInformationAccordion: FC<IProps> = ({ children, color, fontSize, isOpen, label, onChange }) => {
  ...
  return (
    <Accordion allowToggle={true} index={isOpen ? 0 : -1} onChange={handleOnChange} w="full">
      <AccordionItem border="none" w="full">
        <AccordionButton
          ...
          px={DEFAULT_GAP - 2}
        >
          <Text color={color || defaultTextColor} fontSize={fontSize} textAlign="left" w="full">
