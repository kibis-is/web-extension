...
const AssetTabARC0200AssetItem: FC<IProps> = ({ amount, arc0200Asset, network }: IProps) => {
  // hooks
  ...
  // misc
  const standardUnitAmount: BigNumber = convertToStandardUnit(new BigNumber(amount), arc0200Asset.decimals);

  return (
    <Tooltip aria-label="ARC200 asset" label={arc0200Asset.name || arc0200Asset.id}>
      <Button
        _hover={{
