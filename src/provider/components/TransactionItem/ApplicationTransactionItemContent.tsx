...
const ApplicationTransactionItemContent: FC<IProps<IApplicationTransaction>> = ({ transaction }) => {
  ...
  return (
    <>
      <VStack alignItems="flex-start" justifyContent="center" spacing={2} w="full">
        {/*type*/}
