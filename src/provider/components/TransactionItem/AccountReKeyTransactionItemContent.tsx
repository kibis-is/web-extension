...
const AccountReKeyTransactionItemContent: FC<IProps<IAccountReKeyTransaction>> = ({
  accounts,
  network,
  transaction,
}) => {
  ...
  return (
    <>
      <VStack alignItems="flex-start" justifyContent="center" spacing={DEFAULT_GAP / 3} w="full">
        {/*type*/}
