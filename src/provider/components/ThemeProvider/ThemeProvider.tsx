...
// selectors
import { useSelectSettings } from '@provider/selectors';
...
const ThemeProvider: FC<IProps> = ({ children, initialColorMode, initialFontFamily }) => {
  // selectors
  const settings = useSelectSettings();
  // states
  const [colorModeManager] = useState<ColorModeManager>(new ColorModeManager(initialColorMode));
