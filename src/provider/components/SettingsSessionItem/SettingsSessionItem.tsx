...
const SettingsSessionItem: FC<IProps> = ({ item, network, onDisconnect, onSelect }) => {
  ...
  return (
    ...
    >
      {/*icon*/}
      <SessionAvatar name={item.appName} iconUrl={item.iconUrl || undefined} size="sm" />

      {/*details*/}
      <VStack alignItems="flex-start" flexGrow={1} justifyContent="space-evenly" spacing={DEFAULT_GAP / 3}>
        ...
        <HStack alignItems="center" justifyContent="space-between" spacing={DEFAULT_GAP / 2} w="full">
          {/*connected accounts*/}
          <Text color={subTextColor} fontSize="xs" maxW={400} noOfLines={1} textAlign="left">
