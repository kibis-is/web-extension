import { HStack, Input, InputGroup, InputRightElement, Text, Tooltip, VStack } from '@chakra-ui/react';
  ...
  const renderRightInputIcon = () => {
    ...
    return (
      <InputRightElement h={INPUT_HEIGHT}>
        <HStack alignItems="center" h={INPUT_HEIGHT} justifyContent="center" spacing={0}>
          {informationText && (
            <InformationIcon ariaLabel={t<string>('ariaLabels.informationIcon')} tooltipLabel={informationText} />
          )}
          {onSubmit && (
