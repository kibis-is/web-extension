import { Box, Heading, HStack, Skeleton, Text, Tooltip, VStack } from '@chakra-ui/react';
...
const PageHeader: FC<IProps> = ({ colorMode, hideBackButton = false, loading = false, subTitle, title }) => {
  ...
  return (
    <HStack minH={minHeight} mb={DEFAULT_GAP - 2} spacing={DEFAULT_GAP - 2} w="full">
      {/*back button*/}
      {!hideBackButton && (
        <IconButton
          aria-label="Go back"
      ...
      <VStack alignItems="center" justifyContent="center" flexGrow={1} spacing={1} w="full">
        {loading ? (
          <Skeleton>
