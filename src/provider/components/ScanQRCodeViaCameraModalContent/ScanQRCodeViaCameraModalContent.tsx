...
// hooks
import useCameraStream from '@provider/hooks/useCameraStream';
...
const ScanQRCodeViaCameraModalContent: FC<IScanQRCodeModalContentProps> = ({
  ...
  // hooks
  const { error, loading, reset: resetCameraStream, startStream, stream } = useCameraStream();
  ...
  const renderBody = () => {
          ...
          {pagination && (
            <>
              ...
              <CircularProgress
                ...
                value={pagination[1] > 0 ? (pagination[0] / pagination[1]) * 100 : 0}
              />
    ...
    return (
      <>
        {/*progress*/}
        <CircularProgressWithIcon colorMode={colorMode} icon={IoQrCodeOutline} />
