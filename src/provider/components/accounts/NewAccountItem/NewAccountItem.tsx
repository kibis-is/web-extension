...
const NewAccountItem: FC<IProps> = ({ address, name, subTextColor, textColor }) => {
  // hooks
  ...
  return (
    <HStack m={0} p={0} spacing={DEFAULT_GAP / 3} w="full">
      {/*avatar*/}
      <Center>
        <Avatar bg={primaryColor} icon={<Icon as={IoWalletOutline} color={primaryButtonTextColor} />} size="sm" />
      </Center>
