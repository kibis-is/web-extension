import { Center, Tab, TabIndicator, TabList, Tabs, Text } from '@chakra-ui/react';
...
const PillSwitch: FC<IProps> = ({ index, labels, onChange }: IProps) => {
  ...
  return (
    <Tabs isFitted={true} onChange={onChange} position="relative" size="md" variant="unstyled">
      <TabList bg={borderColor} borderRadius={theme.radii['3xl']} py={padding} px={padding * 2}>
