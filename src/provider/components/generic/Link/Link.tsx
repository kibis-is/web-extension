...
import { Button, ButtonProps, Link as ChakraLink, type LinkProps } from '@chakra-ui/react';
...
const Link: ForwardRefExoticComponent<
  PropsWithoutRef<LinkProps> & PropsWithoutRef<ButtonProps> & RefAttributes<HTMLButtonElement>
