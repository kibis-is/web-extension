...
// types
import type { IActiveAccountDetails, IMainRootState } from '@provider/types';
...
export default function useSelectActiveAccountDetails(): IActiveAccountDetails | null {
  return useSelector<IMainRootState, IActiveAccountDetails | null>((state) => state.accounts.activeAccountDetails);
}
