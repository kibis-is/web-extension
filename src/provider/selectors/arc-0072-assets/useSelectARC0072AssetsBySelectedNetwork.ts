...
// types
import type { IARC0072Asset, IMainRootState } from '@provider/types';
...
export default function useSelectARC0072AssetsBySelectedNetwork(): IARC0072Asset[] {
  return useSelector<IMainRootState, IARC0072Asset[]>((state) => {
    ...
    return state.arc0072Assets.items ? state.arc0072Assets.items[convertGenesisHashToHex(network.genesisHash)] : [];
  });
}
