...
// types
import type { IARC0300BaseSchema, IARC0300PaginationQueryItem } from '@provider/types';
 ...
 */
export default function isARC0300SchemaPaginationComplete(schemas: (IARC0300BaseSchema | null)[]): boolean {
  ...
  pageTotal = (schemas[0]?.query[ARC0300QueryEnum.Page] as IARC0300PaginationQueryItem)?.total;
  ...
  schemas.forEach((schema) => {
    page = (schema?.query[ARC0300QueryEnum.Page] as IARC0300PaginationQueryItem | undefined)?.page;
