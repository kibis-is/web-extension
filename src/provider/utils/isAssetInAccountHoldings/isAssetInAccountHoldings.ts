 ...
 */
export default function isAssetInAccountHoldings({ account, asset, network }: IOptions): boolean {
  ...
  switch (asset.type) {
    case AssetTypeEnum.ARC0200:
      return !!accountInformation.arc200AssetHoldings.find((value) => value.id === asset.id);
    case AssetTypeEnum.Standard:
      return !!accountInformation.standardAssetHoldings.find((value) => value.id === asset.id);
    default:
      return false;
  }
}
