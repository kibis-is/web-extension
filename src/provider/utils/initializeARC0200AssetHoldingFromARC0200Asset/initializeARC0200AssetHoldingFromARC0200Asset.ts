...
// types
import type { IARC0200Asset, IARC0200AssetHolding } from '@provider/types';
 ...
 */
export default function initializeARC0200AssetHoldingFromARC0200Asset({ id }: IARC0200Asset): IARC0200AssetHolding {
  return {
    amount: '0',
    id,
