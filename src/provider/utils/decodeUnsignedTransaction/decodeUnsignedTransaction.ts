import { decodeUnsignedTransaction as algoSDKDecodeUnsignedTransaction, Transaction } from 'algosdk';
 ...
 */
export default function decodeUnsignedTransaction(encodedUnsignedTransaction: Uint8Array): Transaction {
  const decodedUnsignedTransaction: Transaction = algoSDKDecodeUnsignedTransaction(encodedUnsignedTransaction);

  // enforce 0 if undefined
  decodedUnsignedTransaction.amount = decodedUnsignedTransaction.amount || BigInt(0);
