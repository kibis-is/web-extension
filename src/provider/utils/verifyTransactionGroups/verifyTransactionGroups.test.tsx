...
function createTransactions(numOfTransactions: number, fromAddress: string, toAddress: string): Transaction[] {
...
describe(`${__dirname}/verifyTransactionGroups()`, () => {
  ...
  describe('when using a single transaction', () => {
    it('should return true if the transaction list has one entry and no group id (a single transaction)', () => {
      // arrange
      // act
      const result: boolean = verifyTransactionGroups(createTransactions(1, fromAccount.addr, toAccount.addr));
    ...
    it('should return true if the transaction list has one entry and a group id (a single transaction)', () => {
      // arrange
      let transactions: Transaction[] = createTransactions(1, fromAccount.addr, toAccount.addr);
  ...
  describe('when using atomic transactions', () => {
    it('should return true if there is a single group atomic transactions', () => {
      // arrange
      let atomicTransactionss: Transaction[] = createTransactions(5, fromAccount.addr, toAccount.addr);
      let result: boolean;
    ...
    it('should return true if there is multiple atomic transactions', () => {
      // arrange
      let atomicTransactionsOne: Transaction[] = createTransactions(5, fromAccount.addr, toAccount.addr);
      let atomicTransactionsTwo: Transaction[] = createTransactions(5, fromAccount.addr, toAccount.addr);
      let result: boolean;
      ...
      // act
      result = verifyTransactionGroups([...atomicTransactionsOne, ...atomicTransactionsTwo]);
  ...
  describe('when there is a mix of atomic transactions and single transactions', () => {
    it('should return true if the there are atomic transactions and a single transaction', () => {
      // arrange
      const transactions: Transaction[] = createTransactions(4, fromAccount.addr, toAccount.addr);
      let result: boolean;
    ...
    it('should return true if there are multiple atomic transactions and single transactions', () => {
      ...
      // act
      result = verifyTransactionGroups([...atomicTransactionsOne, singleTransaction, ...atomicTransactionsTwo]);
    ...
    it('should return true if there are more than 16 groups of multiple atomic transactions and single transactions', () => {
      ...
      atomicTransactions = atomicTransactions.map((value) => assignGroupID(value));

      // act
      result = verifyTransactionGroups([...atomicTransactions.flat(), singleTransaction]);
