 ...
 * the genesis hash.
 */
export default function selectNodeIDByGenesisHashFromSettings({ genesisHash, settings }: IOptions): string | null {
  return settings.general.selectedNodeIDs[convertGenesisHashToHex(genesisHash)] || null;
}
