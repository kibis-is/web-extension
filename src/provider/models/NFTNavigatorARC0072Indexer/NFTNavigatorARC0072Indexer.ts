...
import type { IFetchTokensByOwnerOptions, INewOptions } from '@provider/models/BaseARC0072Indexer';
...
export default class NFTNavigatorARC0072Indexer extends BaseARC0072Indexer {
  ...
  public async fetchTokensByOwner(options: IFetchTokensByOwnerOptions): Promise<IARC0072AssetHolding[]> {
