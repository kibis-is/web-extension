...
// utils
import validateNewPasswordInput from '@provider/utils/validateNewPasswordInput';
import calculateScore from './utils/calculateScore';

export default function useNewPasswordInput({ label, required }: IOptions): IState {
