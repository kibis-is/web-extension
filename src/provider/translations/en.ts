...
// types
import { IResourceLanguage } from '@provider/types';
...
const translation: IResourceLanguage = {
  ...
  captions: {
    ...
    addAsset: 'Enter an asset ID, name, symbol or application ID (for ARC-200).',
    addAssetConfirming: 'Please wait while we confirm the opt-in of the asset {{symbol}} with the network.',
    [`addAssetConfirming_${AssetTypeEnum.ARC0200}`]: 'Adding asset {{symbol}}.',
    addAssetForWatchAccount: 'Enter an application ID (for ARC-200).',
    addAssetForWatchAccountWarning: 'This is a watch account and only ARC-0200 assets can be added.',
    addAssetURI: 'You are about to add the following asset. Select which account your would like to add the asset to.',
    addedAccount: 'Account {{address}} has been added.',
    addedAccounts: 'Added {{amount}} accounts.',
    addedToGroup: 'Added to "{{group}}" group.',
    addPasskey1: 'Adding a passkey allows you to sign transactions without your password.',
    ...
    allowAccountPasskeys: 'You will be able to sign-in to web apps using your AVM accounts via passkeys.',
    ...
    allowDidTokenFormat: 'The DID token format "did:algo:<public_address>" will be an option when sharing an address.',
    ...
    [`appOnComplete_${TransactionTypeEnum.ApplicationCreate}`]: 'This transaction will create a new application.',
    [`appOnComplete_${TransactionTypeEnum.ApplicationDelete}`]: 'This transaction will delete the application.',
    ...
    audienceDoesNotMatch: 'The intended recipient of this token, does not match the host',
    cameraQRCodeScanNotAllowed1: 'Camera access has been denied.',
    cameraQRCodeScanNotAllowed2: 'You will need to go into your settings and allow access.',
    changePassword1: 'Enter your new password.',
    changePassword2: 'You will be prompted to enter your current password when you press "Change Password".',
    ...
    confirmingTransaction: 'Your transaction(s) are being sent to the network to be processed.',
    confirmingTransactionWithAmount: '{{number}} transaction(s) are being sent to the network to be processed.',
    connectingToWalletConnect: 'Attempting to connect to WalletConnect.',
    copied: 'Copied!',
    createNewAccount: 'Create a new account. You will be prompted to save a seed phrase.',
    createPassword1: `First, let's create a new password to secure this device.`,
    createPassword2: 'This password will be used to encrypt your private keys, so make it strong!',
    customNodeAdded: '"{{name}}" added for network "{{genesisID}}".',
    customNodes: 'Here you can add a custom node and, if activated, will be used to make all requests to the network.',
    debugLogging: 'Debugging information will be output to the extension console.',
    ...
    enableCredentialsLock: 'Credentials will only be required due to inactivity.',
    enableRequest: 'An application is requesting to connect. Select which accounts you would like to enable:',
    ...
    enterWatchAccountAddress: 'Enter the address of the account you would like to watch.',
    ...
    failedToGetCustomNodeDetails: 'Unable to connect to custom node at "{{url}}".',
    ...
    higherFee: 'The fee is higher as this is the first time the recipient has interacted with the {{symbol}} asset.',
    ...
    initializingWalletConnect: 'Putting the final touches into your WalletConnect interface.',
    invalidAlgorithm: `The suggested signing method does not match the method that will be used to sign this token`,
    keyRegistrationURI: 'You are about to register a participation key {{status}}.',
    ...
    mustEnterPasswordToAuthorizeOptIn: 'You must enter your password to authorize an opt-in transaction.',
    mustEnterPasswordToAuthorizeOptOut: 'You must enter your password to authorize an opt-out transaction.',
    mustEnterPasswordToAuthorizeReKey: 'You must enter your password to authorize the re-keying of the account.',
    mustEnterPasswordToAuthorizeUndoReKey: 'You must enter your password to authorize the undo re-key.',
    ...
    mustEnterPasswordToImportAccount: 'You must enter your password to import this account.',
    mustEnterPasswordToReEncryptPrivateKeys: `Enter your password to re-encrypt the private keys.`,
    mustEnterPasswordToAuthenticatePasskey: 'Enter your password to authenticate a passkey.',
    mustEnterPasswordToRegisterPasskey: 'Enter your password to register a passkey.',
    mustEnterPasswordToSign: 'Enter your password to sign.',
    mustEnterPasswordToSignSecurityToken: 'Enter your password to sign this security token.',
    mustEnterPasswordToSignTransaction: 'Enter your password to sign this transaction.',
    mustEnterPasswordToSignTransactions: 'Enter your password to sign these transactions.',
    mustEnterPasswordToSendTransaction: 'You must enter your password to send transaction.',
    ...
    noAccountsFound: 'You can create a new account or import an existing account.',
    ...
    noEnVoiNamesAvailable: 'No enVoi names available',
    ...
    participationKeyExpiresAtWarning: 'This is an estimated date based on the current block time.',
    passkeyAdded: 'Passkey {{name}} added!',
    passkeyNotRequested: 'Passkey not requested',
    passkeyRemoved: 'Passkey {{name}} removed.',
    passkeyNotSupported1: 'Unfortunately your browser does not support passkeys.',
    passkeyNotSupported2: 'Try updating your browser to the latest or a newer version.',
    passwordScoreInfo:
    ...
    reKeyAccount: 'You are about to re-key an account with an authorized address.',
    ...
    removeAccountPasskeyConfirm: 'Are you sure you want to remove the passkey for "{{name}}"?',
    removeAccountWarning: 'To add this account back you will need the seed phrase',
    removeAsset: 'Are you sure you want to remove {{symbol}}? You will have to opt-in to this asset again.',
    ...
    removeAssetConfirming: 'Please wait while we confirm the opt-out of the asset {{symbol}} with the network.',
    [`removeAssetConfirming_${AssetTypeEnum.ARC0200}`]: 'Hiding asset {{symbol}}.',
    removeCredentialLock: 'You will need to authenticate to unlock.',
    removeCredentialLock_passkey: 'You will need to authenticate with your passkey to unlock.',
    removeCredentialLock_password: 'You will need to enter your password to unlock.',
    removeCustomNodeConfirm: 'Are you sure you want to remove "{{name}}"?',
    removedFromGroupConfirm: 'Are you sure you want to remove account "{{account}}" from "{{group}}" group?',
    ...
    removeGroupConfirmWarning: 'This action will ONLY remove the group your accounts will remain.',
    removePasskey:
    ...
    requestingPasskeyPermission: 'Requesting permission from the passkey "{{name}}".',
    saveSeedPhrase1: 'Here is your 25 word mnemonic seed phrase; it is the key to your account.',
    saveSeedPhrase2: `Make sure you save this in a secure place.`,
    scannedQrCodes: 'Scanning {{count}} of {{total}} codes',
    scanningForQrCode: 'Scanning for a QR Code. Make sure the QR code is visible in the background.',
    screenCaptureViaQRCodeScanNotAllowed1: 'Screen capture access has been denied.',
    screenCaptureViaQRCodeScanNotAllowed2: 'You will need to go into your settings and allow access.',
    ...
    signTransactionRequest: 'An application is requesting to sign a transaction.',
    signTransactionsRequest: 'An application is requesting to sign multiple transactions.',
    stakingAppAvailableBalanceInfo: 'This is the balance that you are able to withdraw.',
    stakingAppBalanceInfo: 'This is the total balance. The locked-up balance + the available balance (rewards e.t.c).',
    stakingAppStatusOffline: 'This staking app is not participating in staking rewards.',
    stakingAppStatusOnline: 'This staking app is participating and receiving staking rewards.',
    support: 'Please <2>contact us</2> for further assistance so we can resolve this issue for you.',
    transactionIdCopied: 'Transaction ID copied!',
    transactionsSentSuccessfully: '{{amount}} transaction(s) were successfully sent.',
    undoReKeyAccount: 'You are about to remove the authorized account from a re-keyed account.',
    undoReKeyAccountConfirming: 'Please wait while the the authorized account is removed from the re-keyed account.',
    ...
    webAuthnAuthenticateRequestDescription: 'An app is requesting to authenticate using a passkey.',
    webAuthnAuthenticateRequestWaiting: 'Waiting for passkey selection.',
    webAuthnRegisterRequestDescription1: 'An app is requesting to register a new passkey.',
    webAuthnRegisterRequestDescription2: 'Select which account you would like to use to register the passkey.',
  ...
  errors: {
    descriptions: {
      ...
      code_3000: 'You appear to be offline. Please check your internet connection.',
      ...
      code_8002: 'Failed to communicate with the passkey device. Please try again.',
    ...
    inputs: {
      copySeedPhraseRequired: 'You must confirm you have copied the seed phrase',
  ...
  headings: {
    ...
    selectYourEnVoi: 'Select Your EnVoi',
    ...
    [`transaction_${TransactionTypeEnum.AccountUndoReKey}`]: 'Undo Re-Key Account 🔓',
    [`transaction_${TransactionTypeEnum.ApplicationClearState}`]: 'Application Interaction ⚙️',
    [`transaction_${TransactionTypeEnum.ApplicationCloseOut}`]: 'Application Interaction ⚙️',
    [`transaction_${TransactionTypeEnum.ApplicationCreate}`]: 'Application Creation ✨',
    [`transaction_${TransactionTypeEnum.ApplicationDelete}`]: 'Application Deletion 💥',
    [`transaction_${TransactionTypeEnum.ApplicationNoOp}`]: 'Application Interaction ⚙️',
    [`transaction_${TransactionTypeEnum.ApplicationOptIn}`]: 'Application Opt-In 🎟️',
    [`transaction_${TransactionTypeEnum.ApplicationUpdate}`]: 'Application Update 🛠️',
    [`transaction_${TransactionTypeEnum.AssetConfig}`]: 'Asset Re-configuration 🛠️',
    ...
    [`transaction_${TransactionTypeEnum.ARC0200AssetTransfer}`]: 'Asset Transfer 🪙',
    [`transaction_${TransactionTypeEnum.AssetUnfreeze}`]: 'Asset Unfreeze 🚀',
    [`transaction_${TransactionTypeEnum.KeyRegistrationOffline}`]: 'Offline Key Registration 🔑',
    [`transaction_${TransactionTypeEnum.KeyRegistrationOnline}`]: 'Online Key Registration 🔑',
  ...
  labels: {
    ...
    chain: 'Chain',
    chooseAEnVoi: 'Choose your enVoi to display',
    ...
    copySeedPhraseConfirm: 'I confirm I have copied my seed phrase to a secure place.',
    ...
    reKeyTo: 'Re-key To',
    relayingPartyID: 'Relaying Party ID',
    remove: 'Remove',
    removeAccount: 'Remove Account',
  ...
  values: {
    ...
    [`appOnComplete_${TransactionTypeEnum.ApplicationClearState}`]: 'Clear State',
    [`appOnComplete_${TransactionTypeEnum.ApplicationCloseOut}`]: 'Close Out',
    [`appOnComplete_${TransactionTypeEnum.ApplicationCreate}`]: 'Create Application',
    [`appOnComplete_${TransactionTypeEnum.ApplicationDelete}`]: 'Delete Application',
    [`appOnComplete_${TransactionTypeEnum.ApplicationOptIn}`]: 'Application Opt-In',
    [`appOnComplete_${TransactionTypeEnum.ApplicationUpdate}`]: 'Update Application',
  },
};
