...
// selectors
import { useSelectConfirmModal, useSelectSettingsColorMode } from '@provider/selectors';
      ...
      >
        ...
        <ModalBody>
          <VStack spacing={DEFAULT_GAP - 2} w="full">
            ...
            {/*warning text*/}
            {confirm?.warningText && <Notice message={confirm.warningText} size="sm" type="warning" />}
          </VStack>
        </ModalBody>
