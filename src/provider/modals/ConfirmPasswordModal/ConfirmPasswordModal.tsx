import { HStack, Modal, ModalBody, ModalContent, ModalFooter, ModalOverlay, VStack } from '@chakra-ui/react';
import React, { type ChangeEvent, type FC, type KeyboardEvent, useEffect, useRef, useState } from 'react';
...
const ConfirmPasswordModal: FC<IProps> = ({ isOpen, hint, onClose, onConfirm }) => {
  ...
  const handleKeyUpPasswordInput = async (event: KeyboardEvent<HTMLInputElement>) => {
    if (event.key === 'Enter') {
