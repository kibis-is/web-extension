...
// features
import { addARC0200AssetHoldingsThunk } from '@provider/features/accounts';
import {
  clearAssets,
...
const AddAssetsForWatchAccountModal: FC<IModalProps> = ({ onClose }) => {
    ...
    return (
      <VStack flexGrow={1} spacing={DEFAULT_GAP / 2} w="full">
        <VStack px={DEFAULT_GAP} spacing={DEFAULT_GAP / 2} w="full">
          ...
          {/*warning*/}
          <Warning message={t('captions.addAssetForWatchAccountWarning')} size="xs" />
        ...
        {/*asset list*/}
        <VStack flexGrow={1} overflowY="scroll" ref={assetContainerRef} spacing={0} w="full">
          {selectedNetwork &&
  ...
  const renderFooter = () => {
    ...
    if (selectedAsset) {
      return (
        <HStack spacing={DEFAULT_GAP - 2} w="full">
          ...
          <Button colorMode={appearance.theme} onClick={handleAddARC0200AssetClick} size="lg" variant="solid" w="full">
    ...
    return (
      <Button colorMode={appearance.theme} onClick={handleCancelClick} size="lg" variant="outline" w="full">
