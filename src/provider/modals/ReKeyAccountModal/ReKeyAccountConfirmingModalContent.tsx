...
import { IoArrowDownOutline, IoLockClosedOutline, IoLockOpenOutline } from 'react-icons/io5';
  ...
  return (
    ...
    >
      ...
      <Text color={defaultTextColor} fontSize="md" textAlign="center" w="full">
        {t<string>(reKeyType === 'undo' ? 'captions.undoReKeyAccountConfirming' : 'captions.reKeyAccountConfirming')}
      </Text>
