...
const AssetConfigTransactionContent: FC<IAssetTransactionBodyProps> = ({
          ...
          <>
              ...
              <ModalItem
                ...
                value={
                  <HStack spacing={DEFAULT_GAP / 3}>
                    {asset.clawbackAddress !== encodeAddress(transaction.assetClawback.publicKey) ? (
                      <>
                        <AddressDisplay
                          accounts={accounts}
            ...
            {transaction.assetFreeze && asset.freezeAddress && (
              <ModalItem
                ...
                value={
                  <HStack spacing={DEFAULT_GAP / 3}>
                    {asset.freezeAddress !== encodeAddress(transaction.assetFreeze.publicKey) ? (
                      <>
                        <AddressDisplay
                          accounts={accounts}
            ...
            {transaction.assetManager && asset.managerAddress && (
              <ModalItem
                ...
                value={
                  <HStack spacing={DEFAULT_GAP / 3}>
                    {asset.managerAddress !== encodeAddress(transaction.assetManager.publicKey) ? (
                      <>
                        <AddressDisplay
                          accounts={accounts}
            ...
            {transaction.assetReserve && asset.reserveAddress && (
              <ModalItem
                ...
                value={
                  <HStack spacing={DEFAULT_GAP / 3}>
                    {asset.reserveAddress !== encodeAddress(transaction.assetReserve.publicKey) ? (
                      <>
                        <AddressDisplay
                          accounts={accounts}
  ...
  return (
    <VStack alignItems="flex-start" justifyContent="flex-start" spacing={DEFAULT_GAP / 3} w="full">
      ...
      {/*asset name*/}
      {asset.name && <ModalTextItem label={`${t<string>('labels.name')}:`} value={asset.name} />}
