import { HStack, Modal, ModalBody, ModalContent, ModalFooter, ModalOverlay, Text, VStack } from '@chakra-ui/react';
    ...
    if (!forceAuthentication && !isCredentialsRequired) {
      return (
        <VStack alignItems="center" flexGrow={1} justifyContent="center" spacing={DEFAULT_GAP} w="full">
          {/*progress*/}
          <CircularProgressWithIcon colorMode={colorMode} icon={IoLockClosedOutline} />
    ...
    return (
      <VStack w="full">
        <PasswordInput
          ...
          disabled={verifying}
          error={passwordError}
          hint={passwordHint || t<string>('captions.mustEnterPasswordToConfirm')}
