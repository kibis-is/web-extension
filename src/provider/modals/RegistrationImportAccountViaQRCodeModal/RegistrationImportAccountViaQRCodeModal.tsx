...
// selectors
import { useSelectLogger, useSelectNetworks, useSelectSettingsColorMode } from '@provider/selectors';

// theme
import { theme } from '@common/theme';

// types
import type { IARC0300AccountImportSchema, IARC0300BaseSchema, INewAccount } from '@provider/types';
...
const RegistrationImportAccountViaQRCodeModal: FC<IProps> = ({ isOpen, onClose, onComplete, saving }) => {
  ...
  const handleImportClick = (accounts: INewAccount[]) => () => onComplete(accounts);
