...
export default abstract class BaseMessageHandler extends BaseListener {
  ...
  protected abstract _onMiddlewareMessage(message: IBaseMessage<unknown>, sender: Runtime.MessageSender): Promise<void>;

  protected async _sendResponseToMiddleware<Reference, Result, Error = BaseExtensionError>(
